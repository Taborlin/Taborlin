...
(function() {
  ...
  var Taborlinument, cssParse, fs, path, read, yaml, taborlinutils, CleanCSS;
  ...
  taborlinutils = require('./taborlinutils');

  CleanCSS = require('clean-css');

  Taborlinument = (function() {
    function Taborlinument(sourcePath, template) {
    ...
    Taborlinument.prototype.cssParse = function() {
    ...
    Taborlinument.prototype.taborlinParse = function() {
      ...
      results = {
        title: taborlinutils.titlify(path.basename(this.sourcePath)),
        filename: filename,
    ...
    Taborlinument.prototype.parseMarkup = function(comment) {
    ...
    Taborlinument.prototype.isValidComment = function(comment) {
      var commentMatch;
    ...
    return Taborlinument;

  })();

  module.exports = Taborlinument;
